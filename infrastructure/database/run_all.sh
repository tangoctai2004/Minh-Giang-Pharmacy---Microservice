#!/usr/bin/env bash
# =============================================================================
# run_all.sh — Khởi tạo hoàn chỉnh database Nhà Thuốc Minh Giang
# Sử dụng: bash infrastructure/database/run_all.sh (chạy từ thư mục gốc dự án)
# =============================================================================
set -euo pipefail
...
# Danh sách file theo thứ tự thực thi mới
FILES=(
  ...
  "seeds/07_seed_demo_baseline.sql"
  "seeds/08_seed_daily_activity.sql"
  "verify.sql"
)
